...
namespace WineDocumentation.Infrastructure.Service
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<Exception, Task> _onCustomErrorAsync;
        private Func<Exception, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<Exception, Task> onCustomError, 
        ...
        public IHandlerTask OnCustomError(Func<Exception, Logger, Task> onCustomError, 
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
			var customException = exception as Exception;
